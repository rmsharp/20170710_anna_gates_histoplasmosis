...
percent_affected_animals_ever_in_corral <-  100.0 * 
  length(melt_affected_df$value[melt_affected_df$value > 0 &  
...
The data using age matched controls also says that animals that are affected 
spent fewer days of life in a corral.
Having a reduced relative risk (`r signif(corral_affected_vs_unaffected_rr, 2)`)
of being in a corral on any one day of their life.
