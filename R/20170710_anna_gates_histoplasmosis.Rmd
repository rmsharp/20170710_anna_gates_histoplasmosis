...
get_clin_path <- function(conn, id_str, view, affected_df) {
...
chem_df <- get_clin_path(conn, id_str, 
                                  view = "v_clinical_path_chemistry",
                                  exp_df)
cbc_df <- get_clin_path(conn, id_str,
                             view = "v_clinical_path_cbc",
                             exp_df)
cbc_chem <- get_dated_excel_name("cbc_and_clinical_chemistry_of_affecteds")
create_wkbk(file = stri_c("../reports/", cbc_chem), 
            list(cbc_chem_df, 
                 cbc_chem_df[cbc_chem_df$clin_path_days < 365, ], 
                 chem_df, 
